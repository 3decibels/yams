defmodule Msg.Server.Conversation do
  @moduledoc """
  ...
  @doc """
  Starts a `Msg.Server.Conversation` process linked to the current process.
  """
  ...
  defp via_tuple(uuid), do: Msg.Server.ConnectionRegistry.via_tuple{__MODULE__, uuid}
